 ...
 */
final class Version20251105002921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE memory ADD is_extended TINYINT(1) DEFAULT 0 NOT NULL, DROP created_at, DROP updated_at, CHANGE first_name first_name VARCHAR(25) NOT NULL, CHANGE last_name last_name VARCHAR(255) NOT NULL, CHANGE patronymic patronymic VARCHAR(255) NOT NULL, CHANGE date_birth date_birth DATE NOT NULL, CHANGE date_deads date_deads DATE NOT NULL, CHANGE main_photo main_photo VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE memory ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP is_extended, CHANGE first_name first_name VARCHAR(25) DEFAULT NULL, CHANGE last_name last_name VARCHAR(255) DEFAULT NULL, CHANGE patronymic patronymic VARCHAR(255) DEFAULT NULL, CHANGE date_birth date_birth DATE DEFAULT NULL, CHANGE date_deads date_deads DATE DEFAULT NULL, CHANGE main_photo main_photo VARCHAR(255) DEFAULT NULL');
