 ...
 */
final class Version20240618101306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE memory ADD CONSTRAINT FK_EA6D343519EB6921 FOREIGN KEY (client_id) REFERENCES `user` (id)');
    }
