const statsBonusForm = function ($, Routing) {

    $(document).ready(function () {

        const formSelector = '.js--stats-bonus-form';
        ...
        $(".js--stats-bonus-form .filter_datetimepicker").on("dp.change", function (e) {
            Filter.setEmployeesSelect(formSelector);
        });
        ...
        $(formSelector).submit(function (e) {
            ...
            $.ajax({
                url: App.Routing.generate('admin_stats_bonus_ajax'),
                method: 'POST',
                dataType: 'json',
                data: form.serialize()
                ...
                if (responseTable.html.length === 0) {
                    $('.js--stats-bonus-table').html('');
                } else {
                    $('.js--stats-bonus-table').html(responseTable.html);
                    ...
                    var table = $('.js--stats-bonus-table table').DataTable(dataTablesConfig);
                    if ( $(window).width() > 992) {
