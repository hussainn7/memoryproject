const statsEmployeesForm = function ($, Routing) {

    $(document).ready(function () {

        const formSelector = '.js--filter-users-form';
        ...
        $(formSelector).submit(function (e) {
            ...
            $.ajax({
                url: App.Routing.generate('admin_stats_users_ajax'),
                method: 'POST',
                dataType: 'json',
                data: form.serialize()
...
export default statsEmployeesForm;
