const userLogLockForm = function ($, Routing) {

    $(document).ready(function () {

        const formSelector = '.js--user-log-lock-form';
        ...
        $(formSelector).submit(function (e) {
            ...
            $.ajax({
                url: App.Routing.generate('admin_user_log_load_ajax_table_lock_tasks'),
                method: 'POST',
                dataType: 'json',
                data: form.serialize()
...
export default userLogLockForm;
