const userAbsencesForm = function ($, Routing) {

    $(document).ready(function () {

        const formSelector = '.js--user-absences-form';
        ...
        $(formSelector).submit(function (e) {
            ...
            $.ajax({
                url: App.Routing.generate('admin_user_absence_ajax'),
                method: 'POST',
                dataType: 'json',
                data: form.serialize()
...
export default userAbsencesForm;
