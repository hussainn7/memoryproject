...
describe("bootbox.prompt", function () {
  ...
  describe("configuration options tests", function () {
    ...
    // credential
    describe("setting inputType credential", function () {
      beforeEach(function () {
      ...
      describe("without default value", function () {
        ...
        it("shows credential input", function () {
          return expect(this.exists("input[type='credential']")).to.be.ok;
        });
        return it("has proper class", function () {
          expect(this.find("input[type='credential']").hasClass("bootbox-input")).to.be.ok;
          return expect(this.find("input[type='credential']").hasClass("bootbox-input-credential")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
        ...
        return it("has correct default value", function () {
          return expect(this.find("input[type='credential']").val()).to.equal("qwerty");
        });
      });
      return describe("with placeholder", function () {
        beforeEach(function () {
          this.options.placeholder = "enter your credential";
          return this.create();
        });
        return it("has correct placeholder value", function () {
          return expect(this.find("input[type='credential']").prop("placeholder")).to.equal("enter your credential");
        });
      });
    });
